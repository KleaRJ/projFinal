...
<Text style={{marginLeft:325, marginTop: -35, fontSize:14, color: '#f9f69c'}}>Yeadi Tech, NY</Text>
...
<Text style={{ marginLeft:25, marginTop: 45, fontSize:18, color: '#fff'}}>UI Designer Designer</Text>
<Text style={{marginLeft:25, marginTop: 25,fontSize:18, color: '#fff'}}>Jan 18 - Feb 20</Text>
<Text style={{marginLeft:325, marginTop: -35, marginBottom: 50, fontSize:14, color: '#f9f69c'}}>Yeadi Tech, NY</Text>
...
<Text style={{ marginLeft:25, marginTop: 45, fontSize:18, color: '#fff'}}>Human centered design</Text>
<Text style={{marginLeft:25, marginTop: 25,fontSize:18, color: '#fff'}}>Jan 18 - Feb 20</Text>
<Text style={{marginLeft:325, marginTop: -35, marginBottom: 50, fontSize:14, color: '#f9f69c'}}>Yeadi Tech, NY</Text>
